...
export declare const mouseGuard2: <T extends Record<string, any>>(mouseModeTable: T) => (event: MouseEvent | ReactMouseEvent, button: 'left' | 'right' | 'any', modifiers: Array<MouseModifierKey>, fn: () => void) => void;
